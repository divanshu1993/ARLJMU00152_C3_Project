...
import com.app.RestaurantService;
import com.app.restaurantNotFoundException;
...
class RestaurantServiceTest {
    ...
    public void searching_for_non_existing_restaurant_should_throw_exception() throws restaurantNotFoundException {
        Throwable exception = Assertions.assertThrows(restaurantNotFoundException.class,()->{
            service.findRestaurantByName("Amelie's cafe 2");
        } ) ;
        Assertions.assertEquals("Amelie's cafe 2 not found", exception.getMessage());
    }
    //<<<<<<<<<<<<<<<<<<<<SEARCHING>>>>>>>>>>>>>>>>>>>>>>>>>>
